...
unsigned int notes[] = { 392,392,392,329,349,349,349,293,293 };		// ноты для звука
unsigned int note_delay = 400;

void PlaySound();		// функция воспроизведения звука
void StateWords();		// функция, считывающая слова состояния каналов
void CharToBin(unsigned char state, char* str);		// функция перевода в двоичный код
void TurnSpeaker(int isActive);		// функция работы с громкоговорителем
void SetCount(int iDivider);		// функция установки значения счетчика
void Menu();
